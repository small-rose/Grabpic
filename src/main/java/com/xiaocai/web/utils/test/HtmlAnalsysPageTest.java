...
public class HtmlAnalsysPageTest {

	static String url = "https://www.ninilao.com/art/10.html";
	...
	private static void analsysPage(String url){
		...
		for(Element e : elemens){
			...
			//System.out.println("page Element:"+ e.toString());
			
			if(pageList.contains(href)){
				continue;
			}
			System.out.println("页面page no :"+e.text()+", pagehref:"+ href+"pageName");
			analsysPage(href);
			//pageList.add(href);
		}
	}
