...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			<a href="${APP_PATH }/emps "><button type="button" class="btn btn-primary btn-lg">
			Forward Page Demo
			</button></a>
		...
		$("#inputEmpName").change(function(){
			...
			$.ajax({
				...
				success:function(result){
					//console.log(result);
					if(result.code==100){
						show_validate_msg("#inputEmpName","error",result.message);
					}else{
						show_validate_msg("#inputEmpName","success",result.message);
					}
				}
			});
		});
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
       ...
       <form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      ...
		      <span id="empEmailBlock" class="help-block"></span>
		    </div>
		  </div>
		   <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="save_model_btn">保存</button>
      </div>
    </div>
  </div>
</div>
